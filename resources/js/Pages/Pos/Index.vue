      ...
      <div class="flex w-full gap-4">
        ...
        <div class="flex w-1/2 p-8 border-4 border-black rounded-3xl">
          <div class="flex flex-col items-start justify-center w-full px-12">
            ...
            <div
              class="flex items-end justify-between w-full mt-5 mb-4 border-2 border-black rounded-2xl"
            >
            ...
            <div class="flex items-end justify-between w-full mb-5 rounded-2xl">
              <select
                required
            ...
            >
              ...
              <div class="flex items-center w-1/12">
                <input
                  ...
                  class="w-5 h-5 text-black border-2 border-black rounded cursor-pointer"
                />
              </div>
              ...
              <div class="flex justify-end w-1/6">
                <p
                  ...
                  class="text-2xl text-black border-2 border-black rounded-full cursor-pointer"
                >
...
const categories = [
  ...
  { value: "daily_franchise", label: "Daly Franchise" },
  { value: "retail", label: "Retail" },
  { value: "courier_transfer", label: "Courrer Transfer" },
  { value: "pending", label: "Pending" },
  { value: "meeting_order", label: "Meeting Order" },
  { value: "staff_issued", label: "Staff Issued" },
  { value: "director_issued", label: "Director Issued" },
