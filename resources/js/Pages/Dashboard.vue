<template>
  ...
  >
    ...
    <div class="grid w-full h-full grid-cols-4 gap-8 auto-rows-fr">
        ...
        <div class="dashboard-card bg-[#FF1744]">
          <div class="card-content">
            ...
            <div class="text-container">
              ...
              <p class="description">
                Effortlessly manage coupons with options for additions,
                deductions, and returns—all in one centralized platform.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="dashboard-card bg-[#76e02f]">
          <div class="card-content">
            ...
            <div class="text-container">
              ...
              <p class="description">
                Manage essential business details like name, address, contact
                info, and logo for branding on invoices and reports.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="dashboard-card bg-[#e02f82]">
          <div class="card-content">
            ...
            <div class="text-container">
              ...
              <p class="description">
                Handle staff roles, contact details, and access permissions for
        ...
        <div class="dashboard-card bg-[#FFBF00]">
          <div class="card-content">
            ...
            <div class="text-container">
              ...
              <p class="description">
                View and manage past orders with details like date, items, total
                amount, and payment status for easy tracking and reference.
              </p>
            </div>
          </div>
        </div>
      ...
      <Link href="/bill" v-if="HasRole(['Admin'])">
        <div class="dashboard-card bg-[#FFBF00]">
          <div class="card-content">
            <div class="icon-container">
              <img
      ...
      <Link href="/display_stock" v-if="HasRole(['Admin'])">
        <div class="dashboard-card bg-[#FFBF00]">
          <div class="card-content">
            <div class="icon-container">
              <img
