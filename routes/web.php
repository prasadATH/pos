...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/bill', [ApexController::class, 'index']);
    Route::get('/display_stock', [ApexController::class, 'displayStock']);
    Route::get('/edit_order/{orderId}', [ApexController::class, 'editOrder']);
    Route::post('/update_order', [ApexController::class, 'updateOrder']);

    Route::get('/display_stock', [ApexController::class, 'displayStock'])->name('stocks.display');
